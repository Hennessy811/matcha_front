...
export class FeedComponent implements OnInit {
  constructor(private users: UserService, private store: Store<UserState>) {}

  profiles$: Observable<User[]> = this.store.select(
    state => state.user.filterFeed
  );
